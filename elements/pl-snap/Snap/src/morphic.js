...
WorldMorph.prototype.fillPage = function () {
    //changes
    plWindow = document.getElementById('pl-snap');
    var clientHeight = plWindow.offsetHeight,
        clientWidth = plWindow.offsetWidth;
    // // return
    // this.worldCanvas.style.position = "absolute";
    // this.worldCanvas.style.left = "0px";
    // this.worldCanvas.style.right = "0px";
    this.worldCanvas.style.width = plWindow.offsetWidth + 'px';
    this.worldCanvas.style.height = plWindow.offsetHeight;
    ...
    canvas.addEventListener(
        ...
        event => {
            ...
            if (!this.onNextStep) {
                ...
                // change this to not move browser up
